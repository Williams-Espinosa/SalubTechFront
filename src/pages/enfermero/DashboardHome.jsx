...
// Normaliza paciente del backend O del mock
...
// Normaliza tarea del backend O del mock
function normTask(t) {
  return {
    id:      t.id       ?? t.id_tarea,
  ...
  return (
    <div style={{ padding:32, animation:"fadeUp .4s .05s ease both" }}>
      ...
      <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:28, background:"#fff", borderRadius:"var(--radius)", padding:"28px 32px", boxShadow:"var(--shadow-sm)" }}>
        <div>
          <div style={{ fontFamily:"'Syne',sans-serif", fontSize:24, fontWeight:800 }}>Resumen del Turno</div>
        ...
        <div style={{ display:"flex", gap:32, alignItems:"center" }}>
          <div style={{ display:"flex", alignItems:"center", gap:12 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily:"'Syne',sans-serif", fontSize:22, fontWeight:800, fontVariantNumeric:"tabular-nums", letterSpacing:1 }}>{timer}</div>
            </div>
          </div>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:12 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily:"'Syne',sans-serif", fontSize:22, fontWeight:800 }}>{normPatients.length}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 340px", gap:24 }}>
          {/* Patients */}
          <div>
            <div style={{ fontFamily:"'Syne',sans-serif", fontSize:16, fontWeight:700, display:"flex", alignItems:"center", gap:8, marginBottom:20 }}>
